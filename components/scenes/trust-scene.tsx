      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="trust-reveal grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
          <div className="neo-pressed p-6 rounded-2xl text-center">
            ...
            <h3 className="text-sm font-medium text-[#2d3436] mb-2">Transparent</h3>
            <p className="text-xs text-[#7d8da1] font-light">Every line of code is public. Audit the gateway yourself.</p>
          </div>
          <div className="neo-pressed p-6 rounded-2xl text-center">
            <Users className="w-6 h-6 text-[#7d8da1] mx-auto mb-3" />
            <h3 className="text-sm font-medium text-[#2d3436] mb-2">Community</h3>
            <p className="text-xs text-[#7d8da1] font-light">Feature requests, bug reports, and PRs welcome from day one.</p>
          </div>
          <div className="neo-pressed p-6 rounded-2xl text-center">
            <Heart className="w-6 h-6 text-[#7d8da1] mx-auto mb-3" />
            <h3 className="text-sm font-medium text-[#2d3436] mb-2">Honest</h3>
            <p className="text-xs text-[#7d8da1] font-light">We're early. We share what works, what doesn't, and what's next.</p>
          </div>
        </div>
      </div>
    </section>
