        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <a className="text-xs font-light text-[#7d8da1] hover:text-[#44474a] transition-colors" href="https://github.com/cloaky233/Valymux" target="_blank" rel="noopener noreferrer">Star on GitHub</a>
            </div>
          </div>
        </div>
